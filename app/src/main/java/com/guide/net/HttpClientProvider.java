...
public class HttpClientProvider implements Provider<AbstractHttpClient> {
    ...
    @Inject
    private LoggingHttpInterceptor log;
    ...
    public AbstractHttpClient get() {
        ...
        // Turn off stale checking. Our connections break all the ic_start_date anyway,
        // and it's not worth it to pay the penalty of checking every ic_start_date.
