...
public class SwitchView extends LinearLayout implements View.OnClickListener {
    ...
    private void changeColor() {
        if (isChecked) {
            sv_container.setBackgroundResource(R.color.grey);
            iv_switch_cursor.setBackgroundResource(R.color.blue);
//            switch_text_true.setTextColor(Color.WHITE);
//            switch_text_false.setTextColor(Color.GRAY);
        } else {
            iv_switch_cursor.setBackgroundResource(R.color.white);
